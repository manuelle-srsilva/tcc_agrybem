    ...
    if (!$nome || $preco === false || !$medida || !$categoria) {
        ...
        if (!in_array($medida, $validMedidas)) {
            ...
            if($produtoController->cadastroProduto($nome, $preco, $categoria, $medida, $fotoBin, $id_empreendimento)) {
                ...
                $registerMessage = 'Ocorreu um erro ao cadastrar o produto. Tente novamente.';
            }
        }
    }
}
...
<head>
    ...
    <link rel="stylesheet" href="../templates/assets/css/empresa_cadastro_produto1.css">
                    ...
                    <div class="accordion-group">
                        ...
                        <div class="accordion-content">
                            <div class="categoria-opcoes">
                                <label class="categoria-item"><input type="radio" name="categoria" value="Fruta"><span>Fruta</span></label>
                                <label class="categoria-item"><input type="radio" name="categoria" value="Legume"><span>Legume</span></label>
                                <label class="categoria-item"><input type="radio" name="categoria" value="Verdura"><span>Verdura</span></label>
                                <label class="categoria-item"><input type="radio" name="categoria" value="Raiz"><span>Raiz</span></label>
                                <label class="categoria-item"><input type="radio" name="categoria" value="Grãos e Cereais"><span>Grãos e Cereais</span></label>
                                <label class="categoria-item"><input type="radio" name="categoria" value="Ervas e Temperos"><span>Ervas e Temperos</span></label>
                                <label class="categoria-item"><input type="radio" name="categoria" value="Oleaginosas"><span>Oleaginosas</span></label>
                            </div>
                        </div>
                    </div>

                    <!-- UPLOAD DE FOTO (ESTRUTURA CORRIGIDA ) -->
                    <div class="form-group upload-group">
    <label class="form-label">Foto</label>
    <input type="file" id="uploadFoto" name="foto" accept="image/*" class="upload-input">
    <label for="uploadFoto" class="upload-box">
        <div id="upload-content">
            <img src="../templates/assets/img/upload-de-arquivo 2.png" alt="Ícone de Upload" class="upload-icon">
        </div>
        <img id="previewFoto" alt="Pré-visualização da foto do produto">
    </label>
</div>
